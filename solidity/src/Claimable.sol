...
//     function create(address _beneficiary, uint256 _cliff, uint256 _vesting, uint256 _amount, bool _irrevocable,uint tgeAmount)
//         public
//         onlyOwner
...
//             //for better frontend experience
...
//     uint256 unlockedAmount = SafeMath.div(SafeMath.mul(timeLapsed ,ticket.amount) , vestingInSeconds);
//     return unlockedAmount;
// }
