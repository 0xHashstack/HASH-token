...
contract UpgradeClaimableTest is Test {
    ...
    function testUpgrade() public {
        ...
        newImplementation.initialize(PROXY_ADDRESS,SUPER_ADMIN);
        uint256 ticketId = newImplementation.create(0xe2C8f362154aacE6144Cb9d96f45b9568e0Ea721, 0, 1, 61125000000000000000000000, 50, 1);
        ...
        newImplementation.claimTicket(ticketId,0xe2C8f362154aacE6144Cb9d96f45b9568e0Ea721);
